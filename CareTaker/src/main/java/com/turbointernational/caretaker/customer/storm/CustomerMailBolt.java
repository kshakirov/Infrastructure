...
public class CustomerMailBolt extends BaseBasicBolt {
    ...
    public CustomerMailBolt(String admin_smtp, String admin_smtp_port) {
    ...
    private void sendOrderMailAndGo(Tuple tuple, BasicOutputCollector collector) {
        ...
        Email email = prepareEmail(emailAddress, emailHtmlBody, (String) tpl.get("admin_email"),
                (String) tpl.get("admin_name"), (String) tpl.get("subject"));
    ...
    private Email prepareEmail(String emailAddress, String emailHtmlBody, String admin_email,
                               String admin_name, String subject) {
